...
-- 1--  Print Top 5 Movies 

select m.title as "Movie Name", r.avg_rating as "Movie Rating" from movie m, rating r
where m.id=r.movie_id
order by r.avg_rating desc
limit 5;


-- 2 -- Print Top 5 Highest Grossing Movies 

select title as "Movie Name",country as "Country",
...
-- 3 --  Write query statement to list all actors name and their movie title
...
-- 2----------------------PROCEDURE FOR GENRE/NAMES TABLES----------------------------------------
...
-- write a search procedure to find total number of movies done by person using their name_id
...
begin
    ...
    if I in (select name_id from names) then
		...
		Select concat('Total number of movies =  ',s) as "TOTAL MOVIES";
...
-- 4--------------- Procedure to Search for a Movie by Genre ---------------------------
...
call search_movie_by_genre('action');


-- 5 --------------- Procedure to Search for a Movie by Actor ---------------------------------------
...
call search_movie_by_actor('Hania Amir');
...
-- 1-------------------------FUNCTION TO COUNT MOVIES BY GENRE -------------------------------
...
select count_movies_by_genre ('action') as "Total Movies";


-- 2----------------------------------SEARCH FUNCTION FOR MOVIES IN COUNTRY BY CATEGORY-----------------------------------------
...
select Count_movie('actor','UK') as "Count Movie";



-- 3--------------- Function to Get the Year the Movie Was Released ------------------------
...
-- 4--------------- Function to Get the Rating of the Movie -------------------------------
...
-- 5--------------- Function to Get country by movie name -------------------------------
...
-- 6--------------- Function to Get Movie Names by Year -----------------------------------
...
-- 7--------------- Function to Get Movie Names by Country --------------------------------
...
----------------- Trigger to Validate Update on Rating------------------------------------
